...
def generate_explore_indexes() -> None:
    """
    Generate the explore indexes for the yeast display data.
    This function generates the explore index and combined overview data for all screens in the specified folder and availability.
    ...
    for screen_slug in screen_slugs:
        ...
        filtered_data_df = filtered_data_df.with_columns(
            polars.lit(screen_slug).alias("screen_slug")
        )
